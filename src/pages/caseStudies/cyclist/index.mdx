...
![Graph showing number of biker hires by user type](/images/Cyclist/RideableByUserType.png)
...
![Barplot showing most common rental times based on month](/images/Cyclist/MonthByUserType.png)
...
![Barplot showing most common rental times based on weekdays](/images/Cyclist/WeekdayByUserType.png)
