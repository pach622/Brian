...
<Image
  src={RideableByUser}
  alt="Graph showing number of biker hires by user type"
...
<Image
  src={DistanceByUser}
  alt="Graph showing distance travelled by user type"
  style={{ display: "block", margin: "0 auto" }}
/>
...
<Image
  src={DurationByUser}
  alt="Graph showing time travelled by user type"
  style={{ display: "block", margin: "0 auto" }}
/>
...
<Image
  src={MonthByUser}
  alt="Barplot showing most common rental times based on month"
  style={{ display: "block", margin: "0 auto" }}
/>
...
<Image
  src={WeekdayByUser}
  alt="Barplot showing most common rental times based on weekdays"
  style={{ display: "block", margin: "0 auto" }}
/>
...
<Image
  src={UsesByLocation}
  alt="Map showing most common bike rental locations"
  style={{ display: "block", margin: "0 auto" }}
/>
...
<Image
  src={CyclistLocation}
  alt="Long/Lat Location In Real Life"
  style={{ display: "block", margin: "0 auto" }}
/>
