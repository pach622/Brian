...
import ConfusionMatrix from '../../../components/charts/ConfusionMatrix.svelte';
...
<div class="figure-grid figure-grid-2">
  <div>
    <p class="figure-label">A) Train-Validation Plot</p>
    <LineChart client:visible
      labels={['0', '1', '2']}
      datasets={[
        { label: 'Train', data: [0.585, 0.605, 0.67], borderColor: '#3b82f6', backgroundColor: 'rgba(59,130,246,0.1)' },
        { label: 'Validation', data: [0.66, 0.60, 0.45], borderColor: '#f97316', backgroundColor: 'rgba(249,115,22,0.1)', borderDash: [6, 3] }
      ]}
      xLabel="Epoch"
      yLabel="Accuracy"
      yMin={0.4}
  ...
  <div>
    <p class="figure-label">B) Confusion Matrix</p>
    <ConfusionMatrix client:load
      matrix={[[4051, 8325], [1815, 10767]]}
...
<div class="figure-grid figure-grid-2">
  <div>
    ...
    <LineChart client:visible
      ...
      datasets={[
        { label: 'Train', data: [0.575,0.635,0.65,0.68,0.69,0.70,0.71,0.715,0.705,0.72,0.725,0.72,0.735,0.725,0.73,0.735,0.73], borderColor: '#3b82f6', backgroundColor: 'rgba(59,130,246,0.1)' },
        { label: 'Validation', data: [0.51,0.55,0.62,0.88,0.95,0.97,0.935,0.97,0.97,0.985,0.985,0.985,0.955,0.95,0.95,0.93,0.94], borderColor: '#f97316', backgroundColor: 'rgba(249,115,22,0.1)', borderDash: [6, 3] }
      ]}
      xLabel="Epoch"
      yLabel="Accuracy"
      yMin={0.45}
...
<div class="figure-grid figure-grid-2">
  <div>
    ...
    <LineChart client:visible
      labels={['0', '1', '2']}
      datasets={[
        { label: 'Train', data: [0.635, 0.665, 0.71], borderColor: '#3b82f6', backgroundColor: 'rgba(59,130,246,0.1)' },
        { label: 'Validation', data: [0.91, 0.70, 0.585], borderColor: '#f97316', backgroundColor: 'rgba(249,115,22,0.1)', borderDash: [6, 3] }
      ]}
      xLabel="Epoch"
      yLabel="Accuracy"
      yMin={0.5}
...
<div class="figure-grid figure-grid-2">
  <div>
    ...
    <LineChart client:visible
      ...
      datasets={[
        { label: 'Train', data: [0.583,0.605,0.635,0.64,0.645,0.66,0.661,0.656,0.66,0.68,0.68,0.675,0.685,0.685], borderColor: '#3b82f6', backgroundColor: 'rgba(59,130,246,0.1)' },
        { label: 'Validation', data: [0.61,0.61,0.595,0.62,0.64,0.63,0.65,0.653,0.652,0.655,0.657,0.66,0.66,0.665], borderColor: '#f97316', backgroundColor: 'rgba(249,115,22,0.1)', borderDash: [6, 3] }
      ]}
      xLabel="Epoch"
      yLabel="Accuracy"
      yMin={0.55}
...
<div class="figure-grid figure-grid-2">
  <div>
    ...
    <LineChart client:visible
      ...
      datasets={[
        { label: 'Train', data: [0.83,0.873,0.877,0.895,0.907,0.90,0.915,0.92], borderColor: '#3b82f6', backgroundColor: 'rgba(59,130,246,0.1)' },
        { label: 'Validation', data: [0.89,0.93,0.88,0.94,0.935,0.90,0.92,0.95], borderColor: '#f97316', backgroundColor: 'rgba(249,115,22,0.1)', borderDash: [6, 3] }
      ]}
      xLabel="Epoch"
      yLabel="Accuracy"
      yMin={0.82}
